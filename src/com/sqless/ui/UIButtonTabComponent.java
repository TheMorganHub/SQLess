...
public class UIButtonTabComponent extends JPanel {
    ...
    private final ImageIcon CLOSE_TAB_ICON
            = new ImageIcon(getClass().getResource("/res/icons/ui_client/CLOSE_TAB_ICON.png"));
    private final ImageIcon CLOSE_TAB_ROLLOVER_ICON
            = new ImageIcon(getClass().getResource("/res/icons/ui_client/CLOSE_TAB_ROLLOVER_ICON.png"));
    private final ImageIcon CLOSE_TAB_ICON_PRESSED
            = new ImageIcon(getClass().getResource("/res/icons/ui_client/CLOSE_TAB_PRESSED_ICON.png"));
