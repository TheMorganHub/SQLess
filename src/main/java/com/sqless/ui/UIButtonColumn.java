...
/**
 * The UIButtonColumn class provides a renderer and an editor that looks like a
 ...
 *
 */
public class UIButtonColumn extends AbstractCellEditor
     ...
     * @param enforceMaxWidth
     */
    public UIButtonColumn(JTable table, Action action, int column, boolean enforceMaxWidth) {
        this.table = table;
        this.action = action;
